    ...
    <group scale={avatarScale}>
      <group ref={groupRef}>
        ...
        <Sphere ref={bodyRef} args={[0.9, 32, 32]} scale={[1, 1.3, 0.9]}>
          <meshStandardMaterial color={avatarColor} roughness={0.3} transparent opacity={0.9} />
        </Sphere>

        {/* Inner glow */}
        <Sphere args={[0.75, 32, 32]} scale={[1, 1.2, 0.85]}>
          <meshStandardMaterial color="#ffffff" emissive={avatarColor} emissiveIntensity={0.3} transparent opacity={0.4} />
        </Sphere>
        ...
        {[0, 1, 2, 3, 4].map((i) => (
          ...
          >
            <meshStandardMaterial color={avatarColor} transparent opacity={0.85} />
          </Cone>
        ))}
        ...
        {[0, 1, 2, 3, 4, 5].map((i) => (
          ...
          >
            <meshStandardMaterial color={avatarColor} emissive={avatarColor} emissiveIntensity={0.5} transparent opacity={0.6} />
          </Sphere>
        ))}
      </group>

      {/* Half body (ethereal, semi-transparent) */}
      <AvatarHalfBody color={avatarColor} yOffset={-1.8} bodyScale={0.9} />
    </group>
  );
};
