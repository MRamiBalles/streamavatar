  ...
  return (
    <group scale={avatarScale}>
      <group ref={groupRef}>
        ...
        {/* Left eyebrow */}
        <Cylinder ref={leftBrowRef} args={[0.02, 0.02, 0.2, 8]} position={[-0.35, 0.55, 0.2]} rotation={[0, 0, 0.2]}>
          <meshStandardMaterial color="#5c4a1f" />
        </Cylinder>

        {/* Right eyebrow */}
        <Cylinder ref={rightBrowRef} args={[0.02, 0.02, 0.2, 8]} position={[0.35, 0.55, 0.2]} rotation={[0, 0, -0.2]}>
          <meshStandardMaterial color="#5c4a1f" />
        </Cylinder>
      ...
      {/* Half body */}
      <AvatarHalfBody color={avatarColor} yOffset={-1.3} />
    </group>
  );
};
