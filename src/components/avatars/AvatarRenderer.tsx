...
const AvatarModel = ({ type }: { type: AvatarType }) => {
  ...
  const renderModel = () => {
    switch (type) {
      ...
      case 'alien': return <CustomModelAvatar modelUrl="/models/alien.glb" modelType="glb" initialRotation={[Math.PI, 0, 0]} />;
      case 'scream': return <CustomModelAvatar modelUrl="/models/scream.glb" modelType="glb" initialRotation={[Math.PI, 0, 0]} />;
